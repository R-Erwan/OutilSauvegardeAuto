...
public class SocketConnection {
     ...
     */
    public synchronized boolean logUser(UserClient user) throws IOException, ClassNotFoundException {
    ...
    public synchronized boolean signUser(UserClient user) throws IOException, ClassNotFoundException {
