...
public class FileChecker extends Thread{
    ...
    private final SocketConnection sc; //La connexion au serveur pour faire des requires sur les fichiers
     ...
     */
    public FileChecker(FileWaitingQueue fwq, UserClient userClient, double freq, SocketConnection sc, double nbHeure){
        this.fwq = fwq;
